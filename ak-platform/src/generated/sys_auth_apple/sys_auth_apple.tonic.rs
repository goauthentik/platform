...
pub mod system_auth_apple_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with SystemAuthAppleServer.
    #[async_trait]
    pub trait SystemAuthApple: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct SystemAuthAppleServer<T> {
        inner: Arc<T>,
    ...
    impl<T> SystemAuthAppleServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for SystemAuthAppleServer<T>
    where
        T: SystemAuthApple,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sys_auth_apple.SystemAuthApple/RegisterUser" => {
                    ...
                    struct RegisterUserSvc<T: SystemAuthApple>(pub Arc<T>);
                    impl<
                        T: SystemAuthApple,
                    ...
                    for RegisterUserSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as SystemAuthApple>::register_user(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/sys_auth_apple.SystemAuthApple/RegisterDevice" => {
                    #[allow(non_camel_case_types)]
                    struct RegisterDeviceSvc<T: SystemAuthApple>(pub Arc<T>);
                    impl<
                        T: SystemAuthApple,
                    ...
                    for RegisterDeviceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SystemAuthApple>::register_device(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T> Clone for SystemAuthAppleServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "sys_auth_apple.SystemAuthApple";
    impl<T> tonic::server::NamedService for SystemAuthAppleServer<T> {
