...
pub mod agent_auth_server {
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with AgentAuthServer.
    #[async_trait]
    pub trait AgentAuth: std::marker::Send + std::marker::Sync + 'static {
        async fn who_am_i(
            &self,
        ...
        async fn get_current_token(
            &self,
            request: tonic::Request<super::CurrentTokenRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CurrentTokenResponse>,
            tonic::Status,
        >;
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for AgentAuthServer<T>
    where
        T: AgentAuth,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/agent_auth.AgentAuth/WhoAmI" => {
                    ...
                    struct WhoAmISvc<T: AgentAuth>(pub Arc<T>);
                    impl<T: AgentAuth> tonic::server::UnaryService<super::WhoAmIRequest>
                    for WhoAmISvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AgentAuth>::who_am_i(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/agent_auth.AgentAuth/GetCurrentToken" => {
                    #[allow(non_camel_case_types)]
                    struct GetCurrentTokenSvc<T: AgentAuth>(pub Arc<T>);
                    impl<
                        T: AgentAuth,
                    > tonic::server::UnaryService<super::CurrentTokenRequest>
                    for GetCurrentTokenSvc<T> {
                        type Response = super::CurrentTokenResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentAuth>::get_current_token(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetCurrentTokenSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/agent_auth.AgentAuth/CachedTokenExchange" => {
                    #[allow(non_camel_case_types)]
                    struct CachedTokenExchangeSvc<T: AgentAuth>(pub Arc<T>);
                    impl<
                        T: AgentAuth,
                    > tonic::server::UnaryService<super::TokenExchangeRequest>
                    for CachedTokenExchangeSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentAuth>::cached_token_exchange(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/agent_auth.AgentAuth/Authorize" => {
                    #[allow(non_camel_case_types)]
                    struct AuthorizeSvc<T: AgentAuth>(pub Arc<T>);
                    impl<
                        T: AgentAuth,
                    ...
                    for AuthorizeSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentAuth>::authorize(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for AgentAuthServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "agent_auth.AgentAuth";
    impl<T> tonic::server::NamedService for AgentAuthServer<T> {
