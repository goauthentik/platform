...
impl serde::Serialize for SignDpopProofRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if !self.htu.is_empty() {
            len += 1;
        }
        if self.code_for_c_s256.is_some() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("agent_auth.SignDpopProofRequest", len)?;
        if let Some(v) = self.header.as_ref() {
            struct_ser.serialize_field("header", v)?;
        }
        if !self.htm.is_empty() {
            struct_ser.serialize_field("htm", &self.htm)?;
        }
        if !self.htu.is_empty() {
            struct_ser.serialize_field("htu", &self.htu)?;
        }
        if let Some(v) = self.code_for_c_s256.as_ref() {
            struct_ser.serialize_field("codeForCS256", v)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for SignDpopProofRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "header" => Ok(GeneratedField::Header),
                            "htm" => Ok(GeneratedField::Htm),
                            "htu" => Ok(GeneratedField::Htu),
                            "codeForCS256" | "code_for_c_s256" => Ok(GeneratedField::CodeForCS256),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SignDpopProofRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct agent_auth.SignDpopProofRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SignDpopProofRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut header__ = None;
                let mut htm__ = None;
                let mut htu__ = None;
                let mut code_for_c_s256__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Header => {
                            if header__.is_some() {
                        ...
                        GeneratedField::Htm => {
                            if htm__.is_some() {
                                return Err(serde::de::Error::duplicate_field("htm"));
                            }
                            htm__ = Some(map_.next_value()?);
                        }
                        GeneratedField::Htu => {
                            if htu__.is_some() {
                                return Err(serde::de::Error::duplicate_field("htu"));
                            }
                            htu__ = Some(map_.next_value()?);
                        }
                        GeneratedField::CodeForCS256 => {
                            if code_for_c_s256__.is_some() {
                                return Err(serde::de::Error::duplicate_field("codeForCS256"));
                            }
                            code_for_c_s256__ = map_.next_value()?;
                        }
                    }
                }
                Ok(SignDpopProofRequest {
                    header: header__,
                    htm: htm__.unwrap_or_default(),
                    htu: htu__.unwrap_or_default(),
                    code_for_c_s256: code_for_c_s256__,
                })
            }
        }
        deserializer.deserialize_struct("agent_auth.SignDpopProofRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SignDpopProofResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("agent_auth.SignDpopProofResponse", len)?;
        if let Some(v) = self.header.as_ref() {
            struct_ser.serialize_field("header", v)?;
        }
        if !self.proof.is_empty() {
...
impl<'de> serde::Deserialize<'de> for SignDpopProofResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SignDpopProofResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct agent_auth.SignDpopProofResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SignDpopProofResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut header__ = None;
                ...
                Ok(SignDpopProofResponse {
                    header: header__,
                    proof: proof__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("agent_auth.SignDpopProofResponse", FIELDS, GeneratedVisitor)
    }
}
