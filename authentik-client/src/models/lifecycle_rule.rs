...
pub struct LifecycleRule {
    ...
    pub reviewer_groups_obj: Vec<models::PartialGroup>,
    ...
    pub reviewers_obj: Vec<models::PartialUser>,
...
impl LifecycleRule {
    ...
    pub fn new(
        ...
        reviewer_groups_obj: Vec<models::PartialGroup>,
        reviewers: Vec<uuid::Uuid>,
        reviewers_obj: Vec<models::PartialUser>,
