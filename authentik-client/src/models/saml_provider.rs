...
pub struct SamlProvider {
    ...
    #[serde(rename = "issuer_override", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "url_issuer")]
    pub url_issuer: String,
    /// Get unified SAML endpoint URL (handles SSO and SLO)
    #[serde(rename = "url_unified")]
    pub url_unified: String,
    /// Get IdP-initiated SAML URL
    #[serde(rename = "url_unified_init")]
    pub url_unified_init: String,
    /// Get SSO Post URL
