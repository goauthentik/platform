...
internal enum SessionManager: Sendable {
    ...
    internal enum Method: Sendable {
        ...
        internal enum CreateSession: Sendable {
            ...
            internal typealias Input = CreateSessionRequest
...
extension SessionManager {
    ...
    /// >
    /// > SessionManager for creating/closing sessions
...
extension SessionManager.ClientProtocol {
    ...
    /// - Returns: The result of `handleResponse`.
    internal func createSession<Result>(
        _ message: CreateSessionRequest,
        metadata: GRPCCore.Metadata = [:],
        options: GRPCCore.CallOptions = .defaults,
        onResponse handleResponse: @Sendable @escaping (GRPCCore.ClientResponse<CreateSessionResponse>) async throws -> Result = { response in
            try response.message
        ...
        let request = GRPCCore.ClientRequest<CreateSessionRequest>(
            message: message,
            metadata: metadata
        )
