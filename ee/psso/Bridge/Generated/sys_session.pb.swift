...
nonisolated struct CreateSessionRequest: Sendable {
  ...
  var sshAuth: String {
    get {_sshAuth ?? String()}
    set {_sshAuth = newValue}
  }
  /// Returns true if `sshAuth` has been explicitly set.
  var hasSshAuth: Bool {self._sshAuth != nil}
  /// Clears the value of `sshAuth`. Subsequent reads from it will return its default value.
  mutating func clearSshAuth() {self._sshAuth = nil}
  ...
  fileprivate var _sshAuth: String? = nil
}

nonisolated struct CreateSessionResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct SessionStatusRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct SessionStatusResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct CloseSessionRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct CloseSessionResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated extension CreateSessionRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}username\0\u{1}token\0\u{3}ssh_auth\0\u{2}\u{7}pid\0\u{1}ppid\0")
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self._sshAuth) }()
      case 10: try { try decoder.decodeSingularUInt32Field(value: &self.pid) }()
      case 11: try { try decoder.decodeSingularUInt32Field(value: &self.ppid) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._sshAuth {
      try visitor.visitSingularStringField(value: v, fieldNumber: 3)
    } }()
    if self.pid != 0 {
      try visitor.visitSingularUInt32Field(value: self.pid, fieldNumber: 10)
    }
    if self.ppid != 0 {
      try visitor.visitSingularUInt32Field(value: self.ppid, fieldNumber: 11)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: CreateSessionRequest, rhs: CreateSessionRequest) -> Bool {
    ...
    if lhs._sshAuth != rhs._sshAuth {return false}
    if lhs.pid != rhs.pid {return false}
    if lhs.ppid != rhs.ppid {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
nonisolated extension CreateSessionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: CreateSessionResponse, rhs: CreateSessionResponse) -> Bool {
...
nonisolated extension SessionStatusRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension SessionStatusResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension CloseSessionRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension CloseSessionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
