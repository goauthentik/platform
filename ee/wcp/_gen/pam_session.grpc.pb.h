...
public:
  ...
  public:
    ...
    virtual ::grpc::Status
    RegisterSession(::grpc::ClientContext *context,
                    const ::pam_session::RegisterSessionRequest &request,
                    ::pam_session::RegisterSessionResponse *response) = 0;
    std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
        ::pam_session::RegisterSessionResponse>>
    AsyncRegisterSession(::grpc::ClientContext *context,
                         const ::pam_session::RegisterSessionRequest &request,
                         ::grpc::CompletionQueue *cq) {
      return std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
          ::pam_session::RegisterSessionResponse>>(
          AsyncRegisterSessionRaw(context, request, cq));
    }
    std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
        ::pam_session::RegisterSessionResponse>>
    PrepareAsyncRegisterSession(
        ::grpc::ClientContext *context,
        const ::pam_session::RegisterSessionRequest &request,
        ::grpc::CompletionQueue *cq) {
      return std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
          ::pam_session::RegisterSessionResponse>>(
          PrepareAsyncRegisterSessionRaw(context, request, cq));
    }
    virtual ::grpc::Status
    SessionStatus(::grpc::ClientContext *context,
                  const ::pam_session::SessionStatusRequest &request,
                  ::pam_session::SessionStatusResponse *response) = 0;
    std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
        ::pam_session::SessionStatusResponse>>
    AsyncSessionStatus(::grpc::ClientContext *context,
                       const ::pam_session::SessionStatusRequest &request,
                       ::grpc::CompletionQueue *cq) {
      return std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
          ::pam_session::SessionStatusResponse>>(
          AsyncSessionStatusRaw(context, request, cq));
    }
    std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
        ::pam_session::SessionStatusResponse>>
    PrepareAsyncSessionStatus(
        ::grpc::ClientContext *context,
        const ::pam_session::SessionStatusRequest &request,
        ::grpc::CompletionQueue *cq) {
      return std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
          ::pam_session::SessionStatusResponse>>(
          PrepareAsyncSessionStatusRaw(context, request, cq));
    }
    virtual ::grpc::Status
    CloseSession(::grpc::ClientContext *context,
                 const ::pam_session::CloseSessionRequest &request,
                 ::pam_session::CloseSessionResponse *response) = 0;
    std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
        ::pam_session::CloseSessionResponse>>
    AsyncCloseSession(::grpc::ClientContext *context,
                      const ::pam_session::CloseSessionRequest &request,
                      ::grpc::CompletionQueue *cq) {
      return std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
          ::pam_session::CloseSessionResponse>>(
          AsyncCloseSessionRaw(context, request, cq));
    }
    std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
        ::pam_session::CloseSessionResponse>>
    PrepareAsyncCloseSession(::grpc::ClientContext *context,
      ...
      return std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
          ::pam_session::CloseSessionResponse>>(
          PrepareAsyncCloseSessionRaw(context, request, cq));
    }
    ...
    public:
      ...
      RegisterSession(::grpc::ClientContext *context,
                      const ::pam_session::RegisterSessionRequest *request,
                      ::pam_session::RegisterSessionResponse *response,
      ...
      SessionStatus(::grpc::ClientContext *context,
                    const ::pam_session::SessionStatusRequest *request,
                    ::pam_session::SessionStatusResponse *response,
                    std::function<void(::grpc::Status)>) = 0;
      virtual void
      SessionStatus(::grpc::ClientContext *context,
                    const ::pam_session::SessionStatusRequest *request,
      ...
      CloseSession(::grpc::ClientContext *context,
                   const ::pam_session::CloseSessionRequest *request,
                   ::pam_session::CloseSessionResponse *response,
                   std::function<void(::grpc::Status)>) = 0;
      virtual void
      CloseSession(::grpc::ClientContext *context,
                   const ::pam_session::CloseSessionRequest *request,
  ...
  private:
    virtual ::grpc::ClientAsyncResponseReaderInterface<
        ::pam_session::RegisterSessionResponse> *
    AsyncRegisterSessionRaw(
        ::grpc::ClientContext *context,
        const ::pam_session::RegisterSessionRequest &request,
        ::grpc::CompletionQueue *cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface<
        ::pam_session::RegisterSessionResponse> *
    PrepareAsyncRegisterSessionRaw(
        ::grpc::ClientContext *context,
        const ::pam_session::RegisterSessionRequest &request,
        ::grpc::CompletionQueue *cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface<
        ::pam_session::SessionStatusResponse> *
    AsyncSessionStatusRaw(::grpc::ClientContext *context,
                          const ::pam_session::SessionStatusRequest &request,
                          ::grpc::CompletionQueue *cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface<
        ::pam_session::SessionStatusResponse> *
    PrepareAsyncSessionStatusRaw(
        ::grpc::ClientContext *context,
        const ::pam_session::SessionStatusRequest &request,
        ::grpc::CompletionQueue *cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface<
  ...
  public:
    ...
    RegisterSession(::grpc::ClientContext *context,
                    const ::pam_session::RegisterSessionRequest &request,
                    ::pam_session::RegisterSessionResponse *response) override;
    ...
    SessionStatus(::grpc::ClientContext *context,
                  const ::pam_session::SessionStatusRequest &request,
                  ::pam_session::SessionStatusResponse *response) override;
    std::unique_ptr<
        ::grpc::ClientAsyncResponseReader<::pam_session::SessionStatusResponse>>
    AsyncSessionStatus(::grpc::ClientContext *context,
                       const ::pam_session::SessionStatusRequest &request,
                       ::grpc::CompletionQueue *cq) {
      return std::unique_ptr<::grpc::ClientAsyncResponseReader<
    ...
    CloseSession(::grpc::ClientContext *context,
                 const ::pam_session::CloseSessionRequest &request,
                 ::pam_session::CloseSessionResponse *response) override;
    std::unique_ptr<
        ::grpc::ClientAsyncResponseReader<::pam_session::CloseSessionResponse>>
    AsyncCloseSession(::grpc::ClientContext *context,
                      const ::pam_session::CloseSessionRequest &request,
                      ::grpc::CompletionQueue *cq) {
      return std::unique_ptr<::grpc::ClientAsyncResponseReader<
    ...
    public:
      void RegisterSession(::grpc::ClientContext *context,
                           const ::pam_session::RegisterSessionRequest *request,
                           ::pam_session::RegisterSessionResponse *response,
      ...
      void SessionStatus(::grpc::ClientContext *context,
                         const ::pam_session::SessionStatusRequest *request,
                         ::pam_session::SessionStatusResponse *response,
                         std::function<void(::grpc::Status)>) override;
      void SessionStatus(::grpc::ClientContext *context,
  ...
  private:
    ...
    ::grpc::ClientAsyncResponseReader<::pam_session::RegisterSessionResponse> *
    AsyncRegisterSessionRaw(
        ::grpc::ClientContext *context,
        const ::pam_session::RegisterSessionRequest &request,
  ...
  public:
    ...
    virtual ~Service();
    virtual ::grpc::Status
    RegisterSession(::grpc::ServerContext *context,
                    const ::pam_session::RegisterSessionRequest *request,
                    ::pam_session::RegisterSessionResponse *response);
    virtual ::grpc::Status
    SessionStatus(::grpc::ServerContext *context,
                  const ::pam_session::SessionStatusRequest *request,
                  ::pam_session::SessionStatusResponse *response);
    virtual ::grpc::Status
    CloseSession(::grpc::ServerContext *context,
                 const ::pam_session::CloseSessionRequest *request,
                 ::pam_session::CloseSessionResponse *response);
  };
  ...
  public:
    WithAsyncMethod_RegisterSession() { ::grpc::Service::MarkMethodAsync(0); }
    ~WithAsyncMethod_RegisterSession() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status RegisterSession(
    ...
    void RequestRegisterSession(
        ::grpc::ServerContext *context,
        ::pam_session::RegisterSessionRequest *request,
  ...
  public:
    WithAsyncMethod_SessionStatus() { ::grpc::Service::MarkMethodAsync(1); }
    ~WithAsyncMethod_SessionStatus() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status SessionStatus(
        ::grpc::ServerContext * /*context*/,
        const ::pam_session::SessionStatusRequest * /*request*/,
        ::pam_session::SessionStatusResponse * /*response*/) override {
      abort();
    ...
    void RequestSessionStatus(
        ::grpc::ServerContext *context,
        ::pam_session::SessionStatusRequest *request,
        ::grpc::ServerAsyncResponseWriter<::pam_session::SessionStatusResponse>
            *response,
        ::grpc::CompletionQueue *new_call_cq,
        ::grpc::ServerCompletionQueue *notification_cq, void *tag) {
  ...
  public:
    WithAsyncMethod_CloseSession() { ::grpc::Service::MarkMethodAsync(2); }
    ...
    void RequestCloseSession(
        ::grpc::ServerContext *context,
        ::pam_session::CloseSessionRequest *request,
        ::grpc::ServerAsyncResponseWriter<::pam_session::CloseSessionResponse>
            *response,
        ::grpc::CompletionQueue *new_call_cq,
        ::grpc::ServerCompletionQueue *notification_cq, void *tag) {
  ...
  typedef WithAsyncMethod_RegisterSession<
      WithAsyncMethod_SessionStatus<WithAsyncMethod_CloseSession<Service>>>
      AsyncService;
  template <class BaseClass>
  ...
  public:
      ...
      ::grpc::Service::MarkMethodCallback(
          0, new ::grpc::internal::CallbackUnaryHandler<
                 ...
                 [this](::grpc::CallbackServerContext *context,
                        const ::pam_session::RegisterSessionRequest *request,
                        ::pam_session::RegisterSessionResponse *response) {
                   return this->RegisterSession(context, request, response);
                 }));
    }
    void SetMessageAllocatorFor_RegisterSession(
        ::grpc::MessageAllocator<::pam_session::RegisterSessionRequest,
                                 ::pam_session::RegisterSessionResponse>
            *allocator) {
      ...
      static_cast<::grpc::internal::CallbackUnaryHandler<
          ::pam_session::RegisterSessionRequest,
          ::pam_session::RegisterSessionResponse> *>(handler)
    ...
    RegisterSession(::grpc::CallbackServerContext * /*context*/,
                    const ::pam_session::RegisterSessionRequest * /*request*/,
                    ::pam_session::RegisterSessionResponse * /*response*/) {
      return nullptr;
    }
  ...
  public:
      ...
      ::grpc::Service::MarkMethodCallback(
          1, new ::grpc::internal::CallbackUnaryHandler<
                 ...
                 [this](::grpc::CallbackServerContext *context,
                        const ::pam_session::SessionStatusRequest *request,
                        ::pam_session::SessionStatusResponse *response) {
                   return this->SessionStatus(context, request, response);
                 }));
    }
    void SetMessageAllocatorFor_SessionStatus(
        ::grpc::MessageAllocator<::pam_session::SessionStatusRequest,
                                 ::pam_session::SessionStatusResponse>
            *allocator) {
      ::grpc::internal::MethodHandler *const handler =
      ...
      static_cast<::grpc::internal::CallbackUnaryHandler<
          ::pam_session::SessionStatusRequest,
          ::pam_session::SessionStatusResponse> *>(handler)
          ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor *
    SessionStatus(::grpc::CallbackServerContext * /*context*/,
                  const ::pam_session::SessionStatusRequest * /*request*/,
                  ::pam_session::SessionStatusResponse * /*response*/) {
      return nullptr;
    }
  ...
  public:
      ...
      ::grpc::Service::MarkMethodCallback(
          2, new ::grpc::internal::CallbackUnaryHandler<
                 ...
                 [this](::grpc::CallbackServerContext *context,
                        const ::pam_session::CloseSessionRequest *request,
                        ::pam_session::CloseSessionResponse *response) {
                   return this->CloseSession(context, request, response);
                 }));
    }
    void SetMessageAllocatorFor_CloseSession(
        ::grpc::MessageAllocator<::pam_session::CloseSessionRequest,
                                 ::pam_session::CloseSessionResponse>
            *allocator) {
      ::grpc::internal::MethodHandler *const handler =
      ...
      static_cast<::grpc::internal::CallbackUnaryHandler<
          ::pam_session::CloseSessionRequest,
          ::pam_session::CloseSessionResponse> *>(handler)
          ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor *
    CloseSession(::grpc::CallbackServerContext * /*context*/,
                 const ::pam_session::CloseSessionRequest * /*request*/,
                 ::pam_session::CloseSessionResponse * /*response*/) {
      return nullptr;
    }
  };
  typedef WithCallbackMethod_RegisterSession<WithCallbackMethod_SessionStatus<
      WithCallbackMethod_CloseSession<Service>>>
      CallbackService;
  ...
  public:
    WithGenericMethod_SessionStatus() { ::grpc::Service::MarkMethodGeneric(1); }
  ...
  public:
    WithGenericMethod_CloseSession() { ::grpc::Service::MarkMethodGeneric(2); }
  ...
  public:
    WithRawMethod_RegisterSession() { ::grpc::Service::MarkMethodRaw(0); }
  ...
  public:
    WithRawMethod_SessionStatus() { ::grpc::Service::MarkMethodRaw(1); }
  ...
  public:
    WithRawMethod_CloseSession() { ::grpc::Service::MarkMethodRaw(2); }
  ...
  public:
          ...
          0, new ::grpc::internal::StreamedUnaryHandler<
                 ...
                 [this](::grpc::ServerContext *context,
                        ::grpc::ServerUnaryStreamer<
                            ::pam_session::RegisterSessionRequest,
                            ::pam_session::RegisterSessionResponse> *streamer) {
                   return this->StreamedRegisterSession(context, streamer);
                 }));
    }
    ...
    virtual ::grpc::Status StreamedRegisterSession(
        ::grpc::ServerContext *context,
        ::grpc::ServerUnaryStreamer<::pam_session::RegisterSessionRequest,
                                    ::pam_session::RegisterSessionResponse>
  ...
  public:
      ...
      ::grpc::Service::MarkMethodStreamed(
          1, new ::grpc::internal::StreamedUnaryHandler<
                 ...
                 [this](::grpc::ServerContext *context,
                        ::grpc::ServerUnaryStreamer<
                            ::pam_session::SessionStatusRequest,
                            ::pam_session::SessionStatusResponse> *streamer) {
                   return this->StreamedSessionStatus(context, streamer);
                 }));
    }
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedSessionStatus(
        ::grpc::ServerContext *context,
        ::grpc::ServerUnaryStreamer<::pam_session::SessionStatusRequest,
                                    ::pam_session::SessionStatusResponse>
            *server_unary_streamer) = 0;
  };
  template <class BaseClass>
  ...
  public:
      ...
      ::grpc::Service::MarkMethodStreamed(
          2, new ::grpc::internal::StreamedUnaryHandler<
                 ...
                 [this](::grpc::ServerContext *context,
                        ::grpc::ServerUnaryStreamer<
                            ::pam_session::CloseSessionRequest,
                            ::pam_session::CloseSessionResponse> *streamer) {
                   return this->StreamedCloseSession(context, streamer);
                 }));
    }
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedCloseSession(
        ::grpc::ServerContext *context,
        ::grpc::ServerUnaryStreamer<::pam_session::CloseSessionRequest,
                                    ::pam_session::CloseSessionResponse>
            *server_unary_streamer) = 0;
  };
  typedef WithStreamedUnaryMethod_RegisterSession<
      WithStreamedUnaryMethod_SessionStatus<
          WithStreamedUnaryMethod_CloseSession<Service>>>
