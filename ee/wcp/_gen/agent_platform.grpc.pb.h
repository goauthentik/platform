...
#ifndef GRPC_agent_5fplatform_2eproto__INCLUDED
#define GRPC_agent_5fplatform_2eproto__INCLUDED
...
public:
  ...
  public:
    ...
    ~WithAsyncMethod_SignedEndpointHeader() override {
  ...
  public:
    ...
    ~WithGenericMethod_SignedEndpointHeader() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status SignedEndpointHeader(
