...
enum FIELD_ID {
  ...
  FI_EDIT_TEXT = 11,
  FI_COMBOBOX = 12,
  FI_NUM_FIELDS = 13, // Note: if new fields are added, keep NUM_FIELDS last.
                      // This is used as a count of the number of fields
};

// The first value indicates when the tile is displayed (selected, not selected)
// the second indicates things like whether the field is enabled, whether it has
// key focus, etc.
...
// The third is the name of the field, NOT the value which will appear in the
// field.
static const CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR
    s_rgCredProvFieldDescriptors[] = {
        {FI_TILEIMAGE, CPFT_TILE_IMAGE, const_cast<LPWSTR>(L"Image"),
         CPFG_CREDENTIAL_PROVIDER_LOGO},
        {FI_LABEL, CPFT_SMALL_TEXT, const_cast<LPWSTR>(L"Tooltip"),
         CPFG_CREDENTIAL_PROVIDER_LABEL},
        {FI_LARGE_TEXT, CPFT_LARGE_TEXT,
         const_cast<LPWSTR>(L"Authentik Credential Provider")},
        ...
        {FI_LAUNCHWINDOW_LINK, CPFT_COMMAND_LINK,
         const_cast<LPWSTR>(L"Launch helper window2")},
        {FI_HIDECONTROLS_LINK, CPFT_COMMAND_LINK,
         const_cast<LPWSTR>(L"Hide additional controls")},
        {FI_FULLNAME_TEXT, CPFT_SMALL_TEXT, const_cast<LPWSTR>(L"Full name: ")},
        {FI_DISPLAYNAME_TEXT, CPFT_SMALL_TEXT,
         const_cast<LPWSTR>(L"Display name: ")},
        {FI_LOGONSTATUS_TEXT, CPFT_SMALL_TEXT,
         const_cast<LPWSTR>(L"Logon status: ")},
