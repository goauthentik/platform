...
class Credential : public ICredentialProviderCredential2,
 ...
 public:
  ...
  IFACEMETHOD(GetFieldState)(DWORD dwFieldID, _Out_ CREDENTIAL_PROVIDER_FIELD_STATE* pcpfs,
  ...
  IFACEMETHOD(GetCheckboxValue)(DWORD dwFieldID, _Out_ BOOL* pbChecked,
  ...
  IFACEMETHOD(GetComboBoxValueAt)(DWORD dwFieldID, DWORD dwItem,
 ...
 private:
  ...
  m_rgCredProvFieldDescriptors[FI_NUM_FIELDS];  // An array holding the type and name of each
                                                // field in the tile.
  FIELD_STATE_PAIR
  m_rgFieldStatePairs[FI_NUM_FIELDS];     // An array holding the state of each field in the tile.
  PWSTR m_rgFieldStrings[FI_NUM_FIELDS];  // An array holding the string value of each field. This
                                          // is different from the name of the field held in
