...
HRESULT FieldDescriptorCopy(_In_ const CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR& rcpfd,
...
HRESULT KerbInteractiveUnlockLogonInit(_In_ PWSTR pwzDomain, _In_ PWSTR pwzUsername,
