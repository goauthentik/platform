...
//
// $hash=6c8e46d9927020dc89df0ee097e2cb303544c3a4$
//
...
enum CefWrapperType {
  ...
  WT_API_VERSION_TEST,
  WT_API_VERSION_TEST_REF_PTR_CLIENT,
  WT_API_VERSION_TEST_REF_PTR_CLIENT_CHILD,
  WT_API_VERSION_TEST_REF_PTR_CLIENT_CHILD_V2,
  WT_API_VERSION_TEST_REF_PTR_LIBRARY,
  WT_API_VERSION_TEST_REF_PTR_LIBRARY_CHILD,
  WT_API_VERSION_TEST_REF_PTR_LIBRARY_CHILD_CHILD,
  WT_API_VERSION_TEST_REF_PTR_LIBRARY_CHILD_CHILD_V1,
  WT_API_VERSION_TEST_REF_PTR_LIBRARY_CHILD_CHILD_V2,
  WT_API_VERSION_TEST_SCOPED_CLIENT,
  WT_API_VERSION_TEST_SCOPED_CLIENT_CHILD,
  WT_API_VERSION_TEST_SCOPED_CLIENT_CHILD_V2,
  WT_API_VERSION_TEST_SCOPED_LIBRARY,
  WT_API_VERSION_TEST_SCOPED_LIBRARY_CHILD,
  WT_API_VERSION_TEST_SCOPED_LIBRARY_CHILD_CHILD,
  WT_API_VERSION_TEST_SCOPED_LIBRARY_CHILD_CHILD_V1,
  ...
  WT_V8_ACCESSOR,
  WT_V8_ARRAY_BUFFER_RELEASE_CALLBACK,
  WT_V8_CONTEXT,
  WT_V8_EXCEPTION,
  WT_V8_HANDLER,
  WT_V8_INTERCEPTOR,
