...
//
// $hash=8ea715cde2d9da76c7434d702dd2dd4e351a3adb$
//

#ifndef CEF_LIBCEF_DLL_CTOCPP_TEST_API_VERSION_TEST_SCOPED_LIBRARY_CHILD_CTOCPP_H_
#define CEF_LIBCEF_DLL_CTOCPP_TEST_API_VERSION_TEST_SCOPED_LIBRARY_CHILD_CTOCPP_H_
#pragma once
...
class CefApiVersionTestScopedLibraryChildCToCpp
...
constexpr auto CefApiVersionTestScopedLibraryChildCToCpp_Wrap =
    CefApiVersionTestScopedLibraryChildCToCpp::Wrap;
constexpr auto CefApiVersionTestScopedLibraryChildCToCpp_UnwrapOwn =
    CefApiVersionTestScopedLibraryChildCToCpp::UnwrapOwn;
