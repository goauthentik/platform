...
func (UnimplementedAgentAuthServer) GetCurrentToken(context.Context, *CurrentTokenRequest) (*CurrentTokenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCurrentToken not implemented")
}
func (UnimplementedAgentAuthServer) CachedTokenExchange(context.Context, *TokenExchangeRequest) (*TokenExchangeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CachedTokenExchange not implemented")
}
func (UnimplementedAgentAuthServer) DeviceTokenExchange(context.Context, *DeviceTokenExchangeRequest) (*TokenExchangeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeviceTokenExchange not implemented")
}
...
func RegisterAgentAuthServer(s grpc.ServiceRegistrar, srv AgentAuthServer) {
	// If the following call panics, it indicates UnimplementedAgentAuthServer was
