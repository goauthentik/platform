...
pub mod pam_client {
    ...
    #[derive(Debug, Clone)]
    pub struct PamClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl PamClient<tonic::transport::Channel> {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> PamClient<InterceptedService<T, F>>
        where
        ...
        {
            PamClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static("/pam.PAM/TokenAuth");
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/pam.PAM/Authorize");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("pam.PAM", "Authorize"));
            self.inner.unary(req, path, codec).await
        }
    }
}
